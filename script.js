...
function displayPortfolio(id) {
  const portfolio = [
    ...
    {
    id: 2,
    title: 'Eco bus transportation',
    description:
      "Transportation company",
    techMobile: ['React', 'Redux', 'Javascript'],
    techDeskstop: ['Codekit', 'Github','Javascript','Bootstrap','Terminal','Codepen'],
    liveLink: '#',
    srcLink: 'https://github.com/V0pe/ecobusproject',
    images: './images/ecobus.png',
  },
  {
  id: 3,
  title: 'Payday Backend',
  description:
    "A financial app that keeps track of daily transactions on different categories",
  techMobile: ['Ruby on rails', 'Ruby', 'Javascript'],
  techDeskstop: ['Codekit', 'Github','Javascript','Bootstrap','Terminal','Codepen'],
  liveLink: '#',
  srcLink: 'https://github.com/V0pe/Payday',
  images: './images/payday backend.png',
  },
  {
    id: 4,
    title: 'Crypto Market',
    description:
      "This application helps users get updated on the current crypto details around the world. I look forward to more user interactive and experience.",
    techMobile: ['Ruby on rails', 'css', 'Javascript'],
    techDeskstop: ['Codekit', 'Github','Javascript','Bootstrap','Terminal','Codepen'],
    liveLink: 'https://cryptosprice.netlify.app/',
    srcLink: 'https://github.com/V0pe/crypto-dict',
    ...
    },
    {
      ...
      title: 'JobforCash',
      description:
        "offer services for cash",
      techMobile: ['Ruby on rails', 'React', 'Javascript'],
      techDeskstop: ['Codekit', 'Github','Javascript','Bootstrap','Terminal','Codepen'],
      liveLink: '#',
      srcLink: 'https://github.com/V0pe/jobforcash_frontend',
      images: './images/jobforcash.png',
      },
      {
        id: 6,
        title: 'Calculator',
        description:
          "This is a single page react project, that gives the best UX for users. All your calculation and mathematics features can be seen here.",
        techMobile: ['React', 'css', 'Javascript'],
        techDeskstop: ['Codekit', 'Github','Javascript','Bootstrap','Terminal','Codepen'],
        liveLink: '#',
        srcLink: 'https://github.com/V0pe/maths-magician',
